...
function RecruiterDashboard() {
  ...
  const initials = (
    firstName.charAt(0) || recruiterName.charAt(0)
  ).toUpperCase();
    ...
    <>
      ...
      <section className="recruiter-metrics">
        <article className="recruiter-metric recruiter-card">
          <span className="recruiter-metric-icon blue">
        ...
        <article className="recruiter-metric recruiter-card">
          <span className="recruiter-metric-icon green">
            <i className="bi bi-people-fill" />
          </span>
          ...
          <div>
            ...
            <a href="#overview">
              View all candidates <i className="bi bi-arrow-right" />
            </a>
          </div>
        </article>

        <article className="recruiter-metric recruiter-card">
          <span className="recruiter-metric-icon purple">
        ...
        <article className="recruiter-metric recruiter-card">
          <span className="recruiter-metric-icon orange">
          ...
          <div>
            ...
            <a href="#overview">
              View interviews <i className="bi bi-arrow-right" />
            </a>
          </div>
        </article>
      </section>
        ...
        <article className="recruiter-card recent-card">
          ...
          {applications.map(([initial, name, role, date, status, tone]) => (
            <div className="recent-row" key={name}>
              ...
              <span className={`recruiter-status ${tone}`}>
                {status}
              </span>
            </div>
          ))}
